...
public class TwirlEffect implements JazzyEffect {
    ...
    public void initView(View item, int position, int scrollDirection) {
        ...
        ViewCompat.setPivotY(item, item.getWidth() / 2);
        ViewCompat.setRotationX(item, INITIAL_ROTATION_X);
        ViewCompat.setRotationY(item, INITIAL_ROTATION_Y * scrollDirection);
        ViewCompat.setRotation(item, INITIAL_ROTATION_Z);
    }
