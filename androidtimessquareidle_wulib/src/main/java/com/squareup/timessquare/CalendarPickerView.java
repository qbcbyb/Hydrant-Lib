...
public class CalendarPickerView extends ListView {
    ...
    private final CalendarView.CellClickListener listener = new CellClickedListener();
    ...
    private class MonthAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            CalendarView monthView = (CalendarView) convertView;
            if (monthView == null) {
                monthView = CalendarView.create(parent, inflater, weekdayNameFormat, listener, today);
            }
            monthView.updateCellViews(months.get(position), cells.get(position));
            return monthView;
        }
    }
