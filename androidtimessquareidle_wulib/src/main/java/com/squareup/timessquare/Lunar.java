...
public class Lunar {
    ...
    final static String dayNumber[] = {"一", "二", "三", "四", "五", "六", "七", "八", "九", "十"};
	...
	*/
    ...
    public static String getChinaDayString(int day) {
        ...
        if (day == 10)
            ...
            return chineseTen[day / 10] + dayNumber[n];
    }
    ...
    public String get_monthordate() {//返回阴历的天
        String result = getChinaDayString(day);
        if ("初一".equals(result)) {
            result = (leap ? "闰" : "") + get_month() + "月";
        }
        return result;
    }
