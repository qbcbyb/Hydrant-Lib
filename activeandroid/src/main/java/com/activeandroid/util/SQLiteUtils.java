...
import com.activeandroid.FieldProperty;
...
public final class SQLiteUtils {
    ...
    public static ArrayList<String> createUniqueDefinition(TableInfo tableInfo) {
        ...
        for (FieldProperty field : tableInfo.getFields()) {
    ...
    public static void createUniqueColumnDefinition(TableInfo tableInfo, FieldProperty field) {
    ...
    public static void createIndexColumnDefinition(TableInfo tableInfo, FieldProperty field) {
        final String name = tableInfo.getColumnName(field);
        final Column column = field.getAnnotation(Column.class);
    ...
    public static String createColumnDefinition(TableInfo tableInfo, FieldProperty field) {
