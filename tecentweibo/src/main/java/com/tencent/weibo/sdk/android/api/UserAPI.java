...
public class UserAPI extends BaseAPI {
     ...
     * 获取自己的详细资料请求url
     */
    private static final String SERVER_URL_USERINFO = API_SERVER + "/user/info";
    /**
     * 获取其他人资料 请求url
     */
     ...
     */
    public void getUserInfo(Context context, String format,
        ...
        startRequest(context, SERVER_URL_USERINFO, mParam, mCallBack,
     ...
     *                     BaseVO.TYPE_BEAN_LIST=3 BaseVO.TYPE_JSON=4
     */
    public void getUserOtherInfo(Context context, String format, String name,
                                 String fopenid, HttpCallback mCallBack,
        ...
        startRequest(context, SERVER_URL_USEROTHERINFO, mParam, mCallBack,
                mTargetClass, BaseAPI.HTTPMETHOD_GET, resultType);
    }
     ...
     *                     B624064BA065E01CB73F835017FE96FA_B624064BA065E01CB73F835017FE96FB_B624064BA065E01CB73F835017FE96FC
     *                     （个数与names保持一致，最多30，可选） names和fopenids至少选一个，若同时存在则以names值为主
     * @param mCallBack    回调函数
     * @param mTargetClass 返回对象类，如果返回json则为null
     * @param resultType   BaseVO.TYPE_BEAN=0 BaseVO.TYPE_LIST=1 BaseVO.TYPE_OBJECT=2
     *                     BaseVO.TYPE_BEAN_LIST=3 BaseVO.TYPE_JSON=4
     */
    public void getUserInfos(Context context, String format, String names,
                             String fopenids, HttpCallback mCallBack,
                             Class<? extends BaseVO> mTargetClass, int resultType) {
        ReqParam mParam = new ReqParam();
        mParam.addParam("scope", "all");
        mParam.addParam("clientip", Util.getLocalIPAddress(context));
        ...
        startRequest(context, SERVER_URL_USERINFOS, mParam, mCallBack,
                mTargetClass, BaseAPI.HTTPMETHOD_GET, resultType);
    }
}
