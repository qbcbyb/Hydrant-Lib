    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!Util.isNetworkAvailable(this)) {
            ...
            try {
                ...
                clientId = Util.getConfig(this).getApp_key().toString();// bundle.getString("APP_KEY");
                redirectUri = Util.getConfig(this).getRedirect_uri();// bundle.getString("REDIRECT_URI");
