...
public class DeckViewConfig {
    ...
    private DeckViewConfig(Context context) {
        ...
        // Interpolators
        fastOutSlowInInterpolator = new LinearInterpolator();// AnimationUtils.loadInterpolator(context,R.interpolator.fast_out_slow_in);
        fastOutLinearInInterpolator = new LinearInterpolator();//AnimationUtils.loadInterpolator(context,R.interpolator.fast_out_linear_in);
        linearOutSlowInInterpolator = new LinearInterpolator();//AnimationUtils.loadInterpolator(context, R.interpolator.linear_out_slow_in);
        quintOutInterpolator = new DecelerateInterpolator(2.5f);//AnimationUtils.loadInterpolator(context,R.interpolator.decelerate_quint);
    }
